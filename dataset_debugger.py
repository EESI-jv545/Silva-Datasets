...
ref_file=pd.read_csv('results/seqs_per_rank/Prokaryotes_fixed_seqs_for_each_'+rank+'.csv')
...
with open('results/chosen_50/Prokaryotes_fixed_'+ rank + '_chosen_half.txt') as f:
